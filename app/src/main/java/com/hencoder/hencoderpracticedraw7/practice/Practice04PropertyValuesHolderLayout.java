    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder sxHolder = PropertyValuesHolder.ofFloat("scaleX", 0, 1);
                PropertyValuesHolder syHolder = PropertyValuesHolder.ofFloat("scaleY", 0, 1);
                PropertyValuesHolder alphaHolder = PropertyValuesHolder.ofFloat("alpha", 0, 1);
                ObjectAnimator animator = ObjectAnimator.ofPropertyValuesHolder(view, sxHolder, syHolder, alphaHolder);
                animator.start();
